    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 }}>
        {MODELS.map(m => (
          <div key={m.name} style={card}>
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: '#e2e8f0', marginBottom: 10 }}>{m.name}</div>
            ...
            <div style={{ paddingTop: 10, borderTop: '1px solid #2a2d3a', display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ fontSize: 11, color: '#64748b' }}>Training set</span>
      ...
      <div style={card}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 0, overflowX: 'auto' }}>
          ...
          <div style={{ backgroundColor: '#0f1117', border: '1px solid #2a2d3a', borderRadius: 4, padding: '10px 16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <span style={{ ...mono, fontSize: 12, color: '#ef4444', width: 28, textAlign: 'center', border: '1px solid #7f1d1d', borderRadius: 2, padding: '1px 4px' }}>2–3</span>
        ...
        <p style={{ fontSize: 12, color: '#64748b', marginTop: 12 }}>
          Threshold: ≥ 2 of 3 models vote anomaly → classified as INTRUSION and saved to database.
        </p>
      </div>
